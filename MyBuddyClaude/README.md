...
## Mellanox Firmware Settings
  ...
  To mess with Mellanox firmware settings:
    ...
    oc process -f /Users/jschless/taj/cairo/mft-diagnostics-template.yaml \                                                                                                                   
  ...
  Once the pod is running, you can exec into it:                                                                                                                                            
    ...
    - ibdev2netdev - Map IB devices to network interfaces                                                                                                                                        - mlxconfig -d /dev/mst/mt4129_pciconf0 query - Query firmware settings                                                                                                                      - ibv_devinfo mlx5_6 - Show RDMA device info                                                                                                                                              
